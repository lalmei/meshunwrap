...
from meshunwrap.utils.logging import (
...
class TestSetUpLogger:
    ...
    def test_set_up_logger_basic(self) -> None:
        ...
        _log_level_env = "_MESHUNWRAP_LOG_LEVEL"
...
def test_set_up_logger_console_creation_not_in_pytest() -> None:
    ...
    with patch("meshunwrap.utils.logging._is_running_in_pytest", return_value=False):
