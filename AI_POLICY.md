...
The meshunwrap project has strict rules for AI usage:
...
These rules apply only to outside contributions to meshunwrap. Maintainers
...
Please remember that meshunwrap is maintained by humans.
...
meshunwrap is written with plenty of AI assistance, and many maintainers embrace
