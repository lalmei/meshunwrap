...
You can run the application with `make run meshunwrap [ARGS...]`.
...
- `docker.image` is the basename: `meshunwrap`
- `docker.image.base` is the base/testing image name: `meshunwrap_base`
- `docker.image.deploy` is the workflow-specific deployment image name: `meshunwrap_<workflow>`
